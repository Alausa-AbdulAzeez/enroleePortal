...
const Step3 = ({ handleDateChange, startDate, handleNext, handlePrev }) => {
  const dependants = [1, 2, 3, 4];
    ...
    <AnimatePresence>
      ...
      >
        <div className="flex justify-between">
          <h1 className="font-bold">Dependant(s) details</h1>
          <h1 className="font-extrabold text-blue-500">Step 3/3</h1>
        </div>
            ...
            <div className="flex flex-wrap gap-5 items-center max-md:flex-col max-md:items-stretch">
              ...
              <div className="relative flex-1">
                <label className="text-xs font-medium text-sky-800 absolute -bottom-[15px]">
                  Select dependant's passport photograph:
                </label>
        ...
        {/* <div className="flex justify-end gap-[20px] mt-[20px]">
          <button
            type="submit"
            className="hover:bg-[#2a5c2a]   bg-[#357535] text-white py-2 px-4 rounded-md h-[40px] self-end "
            onClick={() => {}}
          >
            Add more dependant
          </button>
